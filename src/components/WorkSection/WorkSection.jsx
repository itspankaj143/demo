...
const WorkSection = () => {
	return (
		<>
			<div className='w-[240px] mx-auto   h-[58px] mt-[5rem] flex justify-center items-center'>
				<h2 className='text-[#ed1c24]  text-[52px] font-dm font-[700]'>
					Our Work
				</h2>
			</div>
			<div className=''>
				<OwlCarousel
					items={2.5}
					className='owl-theme mt-20 ml-16 w-[1450px]'
					loop
					margin={0}
				>
					{/* first card */}
